                    ...
                    <div class="flex flex-col">
                      ...
                      <div class="flex-auto text-gray-500 my-1">
                        <span class="mr-3 ">${job.company}</span><span
                          class="mr-3 border-r border-gray-200  max-h-0 text-clip overflow-hidden">${job.locationPlace}, ${job.locationCountryCode}</span>
                      </div>
                    </div>
                  </div>
                </div>
    ...
    document.getElementById(
      "job-form"
                  ...
                  <div>
                      ...
                      <input type="tel" name="phone" id="phone" pattern="[7-9]{1}[0-9]{9}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="999XX909XX" required>
                  </div>
                  ...
                  <div>
                      <label for="link" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Resume Link</label>
                      <input type="text" name="link" id="link"  placeholder="www.linkedin.com/khan_resume" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" required>
                  </div>
